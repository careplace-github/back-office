...
// features
import { OrderDetailAnalyzeView } from 'src/features/orders';
...
export default function OrderDetailPage({ order, services, caregivers }) {
  return (
    <>
      <Head>
        <title> Ver Pedido | Careplace Business </title>
      </Head>

      <DashboardLayout>
        <OrderDetailAnalyzeView order={order} services={services} caregivers={caregivers} />
      </DashboardLayout>
    </>
  );
}
